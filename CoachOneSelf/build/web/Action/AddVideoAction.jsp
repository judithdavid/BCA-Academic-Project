...
<%
    ...
    if (isMultipart) {
        ...
        if (itr.hasNext()) {
            ...
            String file_path = proj_path.getParentFile().getParentFile().getPath() + "\\web\\Videos\\";
    ...
    String insert = "INSERT INTO  `video`(`name`,`age`,`gender`,`description`,`file`)VALUES('" + pname + "','" + age + "','" + gender + "','" + description + "','" + file_name + "')";
