...
<%
    ...
    String pname = "", price = "", url = "", description = "", margin = "";
    ...
    if (isMultipart) {
        ...
        if (itr.hasNext()) {
            ...
            while (f_item.isFormField()) {
                ...
                if (field.equalsIgnoreCase("margin")) {
                    margin = value;
                }
                f_item = (FileItem) itr.next();
            }
    ...
    String insert = "INSERT INTO `product`(`pname`,`description`,`price`,`url`,mprice,`img`)VALUES('" + pname + "','" + description + "','" + price + "','" + url + "','" + margin + "','" + file_name + "')";
