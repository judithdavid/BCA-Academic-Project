        ...
        <div class="row justify-content-center text-center">
            <div class="col-md-8">
                <div class="section-heading mb-sm-5 mb-4">
                    <h3 class="title-style mb-2">Attend Every Questions</h3>

                </div>
            </div>
        </div>
        <form action="Action/AnsQuestions.jsp" method="post" class="signin-form">
            <div class="row t-in justify-content-center">
                ...
                <%
                    ...
                    String query = "SELECT * FROM `questions` WHERE `age`='" + age + "' AND `gender`='" + gender + "' AND `qid`='"+id+"'";
                    System.out.println(query);
                    Iterator i = con.getData(query).iterator();
                    while (i.hasNext()) {
                        Vector v = (Vector) i.next();
                        n = v.get(0).toString();
                        session.setAttribute("QID", n);
                %>
                ...
                <div class="col-lg-4 col-md-6 price-main-info">
                    <div class="price-inner card box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <label class="container1"><%=v.get(4)%>
                                <input type="radio" name="ans" value="<%=v.get(4)%>">
                                <span class="checkmark"></span>
                            </label>
                            <label class="container1"><%=v.get(5)%>
                                <input type="radio" name="ans" value="<%=v.get(5)%>">
                                <span class="checkmark"></span>
                            </label>
