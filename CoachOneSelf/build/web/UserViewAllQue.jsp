        ...
        <div class="row justify-content-center text-center">
            ...
            <div class="row t-in justify-content-center">
                ...
                <%
                    ...
                    String query = "select * from `questions` where `age`='" + age + "' and `gender`='" + gender + "'";
                    ...
                    <div class="price-inner card box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="read-more mt-4 pt-lg-2 text-center">
                                <a href="UserViewQuestions.jsp?id=<%=v.get(0)%>" <button class="btn btn-style mt-sm-3">Expand</button></a>
                            </div>
