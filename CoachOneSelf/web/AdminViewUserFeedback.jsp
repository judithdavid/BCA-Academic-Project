        ...
        <div class="row justify-content-center text-center">
            <div class="col-md-8">
                <div class="section-heading mb-sm-5 mb-4">
                    <h3 class="title-style mb-2">User Feedbacks </h3>
            ...
            <div class="row t-in justify-content-center">
                ...
                <%
                    ...
                    String query = "SELECT DISTINCT f.`question`,a.`ans`,f.`a`,f.`b` FROM `feedback` f,`feedans` a,`login` l WHERE f.`fid`=a.`fid` AND l.`uid`=a.`uid` AND l.`uid`='" + uid + "'";
