    ...
    <div class="container pb-md-5 pb-4">
        <div class="row contact-block">
            <div class="col-lg-7 contact-right mt-5">
                <h3 class="title-style mb-4 pb-2">Add Images</h3>
                <form action="../AddImageAction.jsp" method="post" class="signin-form" enctype="multipart/form-data">
                    <div class="input-grids">
                        <input type="text" name="pname" id="w3lName" placeholder="Enter the images name*"
                    ...
                    <div class="form-input">
                        <textarea name="description" id="w3lMessage" placeholder="Enter the images description *"
                                  required=""></textarea>
                    </div>
